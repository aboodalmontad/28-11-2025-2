...
-- جدول سجل المحذوفات (جديد: لحل مشكلة عودة البيانات المحذوفة)
...
CREATE POLICY "Access Own Deletions" ON public.sync_deletions FOR ALL USING (user_id = public.get_data_owner_id());
